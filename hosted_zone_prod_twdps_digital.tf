...
provider "aws" {
  alias  = "subdomain_prod_cohorts_red"
  region = "us-east-1"
  assume_role {
...
module "subdomain_prod_cohorts_red" {
  source  = "terraform-aws-modules/route53/aws//modules/zones"
  version = "2.0.0"
  create  = true

  providers = {
    aws = aws.subdomain_prod_cohorts_red
  }
...
module "subdomain_zone_delegation_prod_cohorts_red" {
  ...
  depends_on = [module.subdomain_prod_cohorts_red]
}
